...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("NonText", s:selection, "", "bold")
	call <SID>X("SpecialKey", s:selection, "", "")
	call <SID>X("Search", s:background, s:yellow, "")
	call <SID>X("TabLine", s:window, s:foreground, "reverse")
	call <SID>X("TabLineFill", s:window, s:foreground, "reverse")
	call <SID>X("StatusLine", s:window, s:yellow, "bold,reverse")
    ...
    call <SID>X("TODO", s:comment, s:background, "bold")
    call <SID>X("XXX", s:comment, s:background, "bold")
	...
	call <SID>X("diffDelete", s:background, s:red, "bold")
	call <SID>X("diffChange", "", "2B5B77", "")
	call <SID>X("diffText", s:line, s:blue, "bold")
