...
<scheme name="${Name}" version="1" parent_scheme="Default">
  ...
  <colors>
    <option name="ADDED_LINES_COLOR" value="${Foreground}" />
    <option name="ANNOTATIONS_COLOR" value="${Background}" />
    <option name="ANNOTATIONS_MERGED_COLOR" value="${Background}" />
    <option name="CARET_COLOR" value="${Foreground}" />
    <option name="CARET_ROW_COLOR" value="${Current_Line}" />
    <option name="CONSOLE_BACKGROUND_KEY" value="" />
    <option name="GUTTER_BACKGROUND" value="${Background}" />
    <option name="HTML_TAG_TREE_LEVEL0" value="${Purple}" />
    <option name="HTML_TAG_TREE_LEVEL1" value="${Blue}" />
    <option name="HTML_TAG_TREE_LEVEL2" value="${Acqua}" />
    <option name="HTML_TAG_TREE_LEVEL3" value="${Green}" />
    <option name="HTML_TAG_TREE_LEVEL4" value="${Yellow}" />
    <option name="HTML_TAG_TREE_LEVEL5" value="${Orange}" />
    <option name="INDENT_GUIDE" value="${Selection}" />
    <option name="LINE_NUMBERS_COLOR" value="${Foreground}" />
    <option name="METHOD_SEPARATORS_COLOR" value="" />
    <option name="MODIFIED_LINES_COLOR" value="${Current_Line}" />
    ...
    <option name="RECURSIVE_CALL_ATTRIBUTES" value="${Purple}" />
    <option name="RIGHT_MARGIN_COLOR" value="${Selection}" />
    <option name="SELECTED_INDENT_GUIDE" value="${Selection}" />
    <option name="SELECTED_TEARLINE_COLOR" value="${Background}" />
    <option name="SELECTION_BACKGROUND" value="${Selection}" />
    <option name="SELECTION_FOREGROUND" value="" />
    <option name="TEARLINE_COLOR" value="${Selection}" />
    <option name="WHITESPACES" value="${Selection}" />
  </colors>
  <attributes>
    ...
    <option name="APACHE_CONFIG.COMMENT">
      <value>
        <option name="FOREGROUND" value="${Comment}" />
        <option name="BACKGROUND" />
    ...
    <option name="BUILDOUT.KEY_VALUE_SEPARATOR">
      <value>
        <option name="FOREGROUND" value="${Acqua}" />
        <option name="BACKGROUND" />
        <option name="FONT_TYPE" value="0" />
        <option name="EFFECT_COLOR" />
        <option name="EFFECT_TYPE" value="0" />
    ...
    <option name="COFFEESCRIPT.JAVASCRIPT_ID">
      <value>
        <option name="FOREGROUND" value="${Background}" />
        <option name="BACKGROUND" value="${Blue}" />
        <option name="FONT_TYPE" value="1" />
        <option name="EFFECT_COLOR" />
        <option name="EFFECT_TYPE" value="0" />
        <option name="ERROR_STRIPE_COLOR" />
    ...
    <option name="IDENTIFIER_UNDER_CARET_ATTRIBUTES">
      <value>
        <option name="FOREGROUND" value="${Background}" />
        <option name="BACKGROUND" value="e77673" />
        <option name="FONT_TYPE" value="0" />
        <option name="EFFECT_COLOR" />
        <option name="EFFECT_TYPE" value="0" />
        <option name="ERROR_STRIPE_COLOR" />
    ...
    <option name="JS.ATTRIBUTE">
      <value>
        <option name="FOREGROUND" />
        <option name="BACKGROUND" value="${Selection}" />
        <option name="FONT_TYPE" value="0" />
        <option name="EFFECT_COLOR" />
        <option name="EFFECT_TYPE" value="-1" />
        <option name="ERROR_STRIPE_COLOR" />
    ...
    <option name="NOT_USED_ELEMENT_ATTRIBUTES">
      <value>
        ...
        <option name="BACKGROUND" />
        <option name="FONT_TYPE" value="0" />
        <option name="EFFECT_COLOR" value="${Comment}" />
        <option name="EFFECT_TYPE" value="2" />
        <option name="ERROR_STRIPE_COLOR" />
      </value>
    </option>
    ...
    <option name="Unresolved reference access">
      <value>
        ...
        <option name="BACKGROUND" />
        <option name="FONT_TYPE" value="0" />
        <option name="EFFECT_COLOR" value="${Acqua}" />
        <option name="EFFECT_TYPE" value="2" />
